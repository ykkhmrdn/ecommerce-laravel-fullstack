...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 offset-md-1" style="margin-bottom: 4em;">
                <hr>
                ...
                <form action="{{ route('checkout.store') }}" method="POST">
                    ...
                    <div class="col-md-12 my-5">
                        <div class="card border-primary">
                            <div class="card-header bg-primary text-white">Upload Bukti Pembayaran</div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="payment_proof" class="light-text">Pilih file bukti pembayaran:</label>
                                    <input type="file" class="form-control-file" id="payment_proof">
                                    <small class="form-text text-muted">Upload bukti pembayaran Anda di sini.</small>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-5 offset-md-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('shop.show', $item->model->slug) }}" class="text-decoration-none">
                                        ...
                                        <h3 class="light-text lead text-small">Rp.{{ $item->model->price }}</h3>
                                    </a>
                                </td>
                                <td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 offset-md-4">
                        <span class="light-text" style="display: inline-block">Rp. {{ format($subtotal) }}</span>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 offset-md-4">
                        <span class="light-text" style="display: inline-block">Rp. {{ format($tax) }}</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 offset-md-4">
                        <span class="text-right" style="display: inline-block">Rp. {{ format($total) }}</span>
                    </div>
                </div>
                <hr>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info" role="alert">
                                ...
                                <p>Silakan lakukan pembayaran ke rekening bank berikut ini:</p>
                                <hr>
                                <p class="mb-0"><strong>Bank:</strong> BCA</p>
                                <p class="mb-0"><strong>Nomor Rekening:</strong> 0283313333</p>
                                <p class="mb-0"><strong>Atas Nama:</strong> PT Sumber Maju Dunia</p>
                                <hr>
                                <p class="mb-0">Setelah melakukan pembayaran, mohon konfirmasi melalui halaman konfirmasi
                                    pembayaran yang telah kami sediakan.</p>
                            </div>
                        </div>
                    </div>
                </div>
                @if (!session()->has('coupon'))
                    <form action="{{ route('coupon.store') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-success custom-border-success btn-block"
                            style="margin-top: 2em;">Apply Coupon</button>
                    </form>
                @endif
            </div>
