            ...
            <div class="col-md-10 offset-md-1">
                @if (Cart::instance('default')->count() > 0)
                    ...
                    <div class="summary">
                        <div class="row">
                            <div class="col-md-8">
                                <p class="light-text">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Est laborum perspiciatis ullam,
                                    aliquam eius deserunt iusto autem. Cumque omnis, architecto nostrum voluptatum quis
                                    temporibus alias suscipit quod reprehenderit. Quis, esse.
                                </p>
                            </div>
                            <div class="col-md-3 offset-md-1">
                                <p class="text-right light-text">Subtotal &nbsp; &nbsp;Rp. {{ format(Cart::subtotal()) }}</p>
                                <p class="text-right light-text">Tax(21%) &nbsp; &nbsp;Rp. {{ format(Cart::tax()) }}</p>
                                <p class="text-right">Total &nbsp; &nbsp;Rp. {{ format(Cart::total()) }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="cart-actions">
                        <a class="btn custom-border-n btn-outline-primary" href="{{ route('shop.index') }}">Continue
                            Shopping</a>
                ...
                @else
                    <div class="alert alert-info" style="display: flex;">
                        <h4 class="lead">No items in the cart <h4>
                    </div>
                    <a class="btn custom-border-n btn-outline-primary"
                        ...
                        <tbody>
                            @foreach (Cart::instance('saveForLater')->content() as $item)
                                <tr>
                                    ...
                                    <td>Rp.{{ format($item->model->price) }}</td>
                                </tr>
                            @endforeach
                        </tbody>
